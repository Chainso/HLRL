...
def composed_functions(inner_function: Callable, functions: Tuple[Callable],
    *args: Any, **kwargs: Any):
    """
    ...
    Args:
        inner_function (Callable): The innermost function.
        functions (Tuple[Callable]): A variable number of functions to compose.
        *args (Any): Arguments for the innermost function.
        **kwargs (Any): Keyword arguments for the innermost function.
    """
